        ...
        <div class="menu-content">
            <div class="navbar-header">
                <a class="navbar-brand" href="/">
                    <?= Html::img('@web/public/images/logo.jpg', ['alt'=>'logo']) ?>
                </a>
            </div>
...
<footer class="footer-widget-section">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="single-review">
                                    ...
                                    <div class="author-id">
                                        <?= Html::img('@web/public/images/author.png') ?>
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        <div>
                            <?= Html::img('@web/public/images/footer-img.png') ?>
                        </div>
                        <div>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center"><?= date('Y') ?>
                        Built with <i class="fa fa-heart"></i> Yii2
                    </div>
                </div>
            </div>
        </div>
